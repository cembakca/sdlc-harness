...
3. WHEN `Content-Length` is 10485760 or less THE SYSTEM SHALL respond 202.
3b. WHEN `Content-Length` is 10485760 or less THE SYSTEM SHALL create exactly
   one row in the `jobs` collection.
